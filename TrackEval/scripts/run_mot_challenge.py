...
def evaluate_mot17(tracker_path, split, data_path, tracker_sub_folder, output_sub_folder):
    """
    ...
    if 'dancetrack-val' in split or 'bdd-val' in split:
        ...
        dataset_config['GT_FOLDER'] = os.path.join(data_path, dataset, 'train')
...
def evaluate_mot17_with_logs(tracker_path, split, data_path, tracker_sub_folder, output_sub_folder):
    """
    Evaluate MOT17 using TrackEval toolkit
    """
    # tracker_display_name = 'HICL-Tracker'
